$(document).ready(function () {
    $('#signInForm').on('submit', function (event) {
        ...
        // Send AJAX request
        $.ajax({
            url: 'http://localhost:6060/Crop_Monitoring_system/api/v1/auth/signIn', // Backend endpoint
            type: 'POST',
...
$('#signUpForm').on('submit', function (event) {
    ...
    $.ajax({
        url: 'http://localhost:6060/Crop_Monitoring_system/api/v1/auth/signUp', // Backend endpoint
        type: 'POST',
        contentType: 'application/json',
